  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="flex buttons">
          ...
          <button type="button" className={micButtonClass} onClick={this.handleMicClick}>
            <Icon type={audioSource === 'mic' ? 'stop' : 'microphone'} fill='#FFFFFF' /> Record Audio
          </button>

          <button type="button" className={buttonClass} onClick={this.handleUploadClick}>
            <Icon type={audioSource === 'upload' ? 'stop' : 'upload'} fill='#FFFFFF' /> Upload Audio File
          </button>
      ...
      <div className="flexBox">
        ...
        <div className="flexCard">
          <div className="section">Pocket Sphinx</div>
          <div className="message" />
        </div>

        <div className="flexCard">
          <div className="section">Google Speech</div>
          <div className="message" />
        </div>
